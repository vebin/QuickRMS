...
namespace Quick.Framework.Tool.T4
{
    /// <summary>
    /// T4实体模型信息类
    /// </summary>
    public class T4ModelInfo
    {
        ...
        public IEnumerable<PropertyInfo> PropertiesPublic { get; private set; }
        public T4ModelInfo(Type modelType, bool useModuleDir = false)
        {
            ...
            PropertiesPublic = modelType.GetProperties(BindingFlags.Public | BindingFlags.DeclaredOnly);
        }
    }
}
